object receiving_report_frm: Treceiving_report_frm
  Left = 0
  Top = 0
  BorderIcons = []
  ...
  object RzPanel1: TRzPanel
    ...
    object btn_insert_to_transaction: TRzBitBtn
      Left = 0
      Top = 0
      Width = 35
      Height = 35
      Caption = 'btn_insert_to_transaction'
      TabOrder = 0
      Visible = False
      OnClick = btn_insert_to_transactionClick
    end
  end
  object AdvPanel1: TAdvPanel
    ...
    object grd_receiving_report: TAdvStringGrid
      Left = 0
      Top = 184
      Width = 1022
      Height = 449
      ...
      ScrollBars = ssBoth
      TabOrder = 0
      OnClick = grd_receiving_reportClick
      OnDblClick = grd_receiving_reportDblClick
    ...
    object nedt_po_no: TRzNumericEdit
      Left = 113
      Top = 38
      Width = 168
      Height = 21
    ...
    object btn_edit_items: TRzBitBtn
      Left = 134
      Top = 633
      Width = 100
      Height = 35
