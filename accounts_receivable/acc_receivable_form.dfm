object frm_accounts_receivable: Tfrm_accounts_receivable
  Left = 0
  Top = 0
  BorderStyle = bsDialog
  Caption = 'frm_accounts_receivable'
  ClientHeight = 740
  ClientWidth = 930
  Color = clBtnFace
  ...
  object AdvPanel1: TAdvPanel
    ...
    object grd_ar_home: TAdvStringGrid
      Left = 8
      Top = 83
      Width = 914
      Height = 550
      ...
      ScrollBars = ssBoth
      TabOrder = 0
      OnClick = grd_ar_homeClick
      OnDblClick = grd_ar_homeDblClick
